var bg,bgImg
var batter,batterImg, batterAnimation
...
function preload() {
  ...
  batterImg=loadImage("Images/ViratKohli2.jpg")
  ...
  //batterAnimation=loadAnimation("Images/ViratKohli1.png","Images/ViratKohli3.png")
}
...
function setup() {
  ...
  //batter.addAnimation("batter", batterAnimation)
...
//spawnFielder()
  ...
  if(frameCount%50===0){
    ...
    //ball.y=826;
  if(keyDown("SPACE")){
    //batter.changeAnimation("batter", batterAnimation)
...
/*function spawnFielder(){

if(frameCount%60===0){
fielder=createSprite(random(200,1000),random(800,1000),20,20)
fielder.addImage("fielderImge",fielderImg)
}
